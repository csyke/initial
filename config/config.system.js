...
const config = {
    ...
    traccar: {
        host:process.env.TRACCARHOST,
        user:process.env.TRACCARUSER,
        pass:process.env.TRACCARPASS,
        db:process.env.TRACCARDB,
    },
    ...
    callbacks: {
        facebook:'/csymapp/auth/facebook/callback',
        google:'/csymapp/auth/google/callback',
        twitter:'/csymapp/auth/twitter/callback',
        github:'csymapp/auth/github/callback',
        linkedin:'csymapp/auth/linkedin/callback',
    },
    CodeTTL: {
        'Email':24, // hours
        'Telephone': 5 // minutes
     ...
     , mail: {
        ...
        mail: process.env.DEFAULTEMAIL,
        password: process.env.EMAILPASSWORD,
        accountsman: process.env.ACCOUNTSMANMAIL,
    }
